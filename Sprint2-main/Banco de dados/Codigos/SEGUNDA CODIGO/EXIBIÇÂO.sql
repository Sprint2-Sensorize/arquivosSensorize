...
SELECT a.Nome_academia as "NOME DA ACADEMIA",
		SEC_TO_TIME(SUM(TIMESTAMPDIFF(SECOND,data_historico_ativo, data_historico_inativo))) AS "ACUMULO DE TEMPO DE USO DE TODOS OS APARELHOS (10:00 - 14:00)"
			FROM academia as a
				JOIN aparelho
							...
							ON fk_aparelho = aparelho_id
								JOIN historico
									ON fk_sensor = sensor_id
										where data_historico_ativo BETWEEN '2023-10-24 10:00:00' AND '2023-10-24 14:00:00' and grupo_treino = 'inferior';
